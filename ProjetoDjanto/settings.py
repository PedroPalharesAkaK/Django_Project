"""
Django settings for ProjetoDjanto project.
...
# SECURITY WARNING: keep the secret key used in production secret! shiiii
...
ROOT_URLCONF = 'ProjetoDjanto.urls'
...
WSGI_APPLICATION = 'ProjetoDjanto.wsgi.application'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
# As credenciais virão do seu arquivo .env no servidor
