...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(template_name='login.html', authentication_form=EmailOrUsernameAuthenticationForm), name='login'), #temporario
    ...
    path('activate/<uidb64>/<token>/', accounts_views.activate, name='activate'), #rota para ativar conta apos email confirm vide views accounts
